            ...
            >
              {(formik) => (
                <Form className="form">
                  <div className="">
                    <Link href="/" passHref>
                    <Image src={"/denjets.png"} alt="Vercel Logo" className="dark:invert" width={150} height={24} priority />
                    </Link>

                  <h2 className="text-2xl font-bold text-white mb-4">Lets get in touch</h2>
                  </div>
                  <div className="bg-white w-full rounded-md p-4 my-4">
                    <div className="mb-4">
                      ...
                      />
                      <ErrorMessage name="firstName" className="text-red-500" component="div" />
                    </div>
                    <div className="mb-4">
                      <Field
                        id="lastName"
                        ...
                        className="border-black border-2 w-full p-4 rounded-md"
                      />
                      <ErrorMessage name="lastName" className="text-red-500" component="div" />
                    </div>
                    <div className="mb-4">
                      <Field
                        id="email"
